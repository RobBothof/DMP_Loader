...
namespace Mindmagma.Curses
{
    public static partial class NCurses
    {
        ...
        public static void WindowAttributeOff(IntPtr window, uint attributes)
        {
            int result = Native.wattron(window, attributes);
            NativeExceptionHelper.ThrowOnFailure(result, nameof(WindowAttributeOff));
        }

        public static void WindowAttributeOn(IntPtr window, uint attributes)
        {
            int result = Native.wattron(window, attributes);
        ...
        public static void WindowAttributeSet(IntPtr window, uint attributes)
        {
